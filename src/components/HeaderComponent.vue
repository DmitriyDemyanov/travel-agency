<template>
  <section class="navigation d-flex justify-content-between align-items-center" :class='{ sticked: isSticked }'>
    ...
    <div class="d-flex">
<!-- Нет необходимости давать клас item-flight и item-hotel, имя класа не должно пояснять что нарисовано -->
<!-- Правильно клас назвать, описав его функционал, то что он делает с точки зрения сайта -->
      <div class="navigation__link">
<!--  Одна svg height 20, другая height 18, выглядит криво, нужно ровнять, дал navigation__link height 24, -->
<!--  Подровнял при помощи flex и align-items -->
