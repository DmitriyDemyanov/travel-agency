<template>
  <section class='places container-normal'>
    <SectionHeaderComponent :sectionContent='{title: "Plan your perfect trip",subtitle: "Search Flights & Places Hire to our most popular destinations",textBtn: "See more places"}' />
